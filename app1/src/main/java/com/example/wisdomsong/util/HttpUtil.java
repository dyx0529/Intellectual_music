...
import com.example.wisdomsong.bean.Global;
...
public Retrofit getRetrofit(){
    ...
    private OkHttpClient getOkhttpClient() {
            ...
            //指定缓存的路径
            Cache cache = new Cache(new File(BaseApplication.getBaseApplication().getCacheDir(), "Cache"),1024 * 1024 * 10);
        ...
        private class MyCacheinterceptor implements Interceptor {
            ...
            public Response intercept(Chain chain) throws IOException {
                ...
                if (!Net.isNetworkAvailable(BaseApplication.getBaseApplication())) {
